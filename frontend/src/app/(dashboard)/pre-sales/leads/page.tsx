...
const STATUS_BADGES: Record<LeadStatus, { label: string; style: string }> = {
  ...
  LIVE_CASE_DEMONSTRATION: { label: 'LIVE Demonstration', style: 'bg-violet-950 text-violet-300 border-violet-800' },
  QUOTATION: { label: 'Procurement', style: 'bg-cyan-950 text-cyan-300 border-cyan-800' },
