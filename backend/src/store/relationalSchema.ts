...
export const RELATIONAL_TABLES: TableDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      f('live_demo_gate_exempt', 'boolean'),
      f('assigned_team_ids', 'text[]'),
      f('assigned_team_names', 'text[]'),
      f('live_demo_participant_ids', 'text[]'),
  ...
  {
    collection: 'liveDemonstrations',
    table: 'live_demonstrations',
    fields: [
      ...text(
        'lead_id',
        'project_id',
        ...
        'customer_action_owner_id',
        'customer_action_owner_name',
        'internal_action_required',
        'action_owner_id',
        'action_owner_name',
        'pending_resolved_by',
        'pending_resolved_by_id',
      ...
      f('follow_up_required', 'boolean'),
      f('support_task_ids', 'jsonb'),
      f('support_user_ids', 'jsonb'),
      f('support_user_names', 'jsonb'),
      f('internal_participant_ids', 'jsonb'),
      f('customer_participants', 'jsonb'),
      f('checklist', 'jsonb'),
      f('schedule_history', 'jsonb'),
      f('pending_history', 'jsonb'),
      f('status_history', 'jsonb'),
      ...ts(
        'started_at',
        'completed_at',
        'verified_at',
