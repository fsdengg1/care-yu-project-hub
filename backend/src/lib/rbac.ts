...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  CTO: ['view:leads', 'edit:lead', 'view:live-demo', 'create:live-demo-request', 'schedule:live-demo', 'assign:live-demo', 'review:live-demo', 'verify:live-demo', 'view:projects', 'view:teams', 'view:audit', 'view:notifications', 'view:daily-updates', 'manage:users', 'create:announcement'],
  BUSINESS_HEAD: [
    'create:lead',
    'edit:lead',
    'view:leads',
  ...
  SALES: ['edit:lead', 'view:leads', 'view:live-demo', 'create:live-demo-request', 'schedule:live-demo', 'view:notifications', 'create:quotation', 'convert:lead'],
  PROJECT_MANAGER: [
    'view:leads',
    'edit:lead',
    'assign:lead',
